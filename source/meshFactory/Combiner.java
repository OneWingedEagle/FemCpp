...
public class Combiner {
	...
	public void setRotorPositionbb(Model motor, double newAng, double angStep0){
		if(abs(newAng)>=360) newAng=newAng%360;
		if(newAng<0) newAng=360+newAng;
	...
	if(full){setRotorPositionFull(motor,newAng,angStep0); return;}
		...
		nodeRotated=new boolean[motor.numberOfNodes+1];
...
/*		String bun = System.getProperty("user.dir") + "\\XXX.txt";
