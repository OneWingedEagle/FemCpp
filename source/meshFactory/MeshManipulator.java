...
public class MeshManipulator {
	...
	//	mf.extractReg(8); mf.dropUnusedNodes();
		//mf.pileUpPrism(6, .025);
		
		Model modelx=new Model(System.getProperty("user.dir") + "\\EMSol\\problem20.txt");
		
	//mf.fetchNodeCoord(modelx,37593).hshow();;//.sub(mf.fetchNodeCoord(modelx,15733)).hshow();		
		//util.pr(mf.fetchNodeCoord(2185).v2().norm());
		
		//mf.extractReg(0,1,0,PI/2,-1,1);
